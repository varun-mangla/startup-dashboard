...
st.subheader("This App gives an overview of amount invested in indian  startups and about their investors.")
st.subheader("Select 'STARTUP/INVESTOR' name on the sidebar menu and for overall Select 'OVERALL ANALSYSIS'")
